 ...
 * USe WI-FI UDP protocol in C langugage
 * tutorial url: https://osoyoo.com/2020/11/08/osoyoo-pie-v2-0-car-lesson-4-use-mobile-app-to-control-car-with-udpc-language/
 */
...
//  gcc -pthread -o udp udp.c pca9685/pca9685.c -lwiringPi 